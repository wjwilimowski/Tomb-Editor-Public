...
namespace TombLib.Tests.LevelData.Instances
{
    public class ObjectGroupTests
    {
        ...
        [Fact]
        public void SetRotation_AdjustsChildRotationsByDifference()
        {
            // Arrange
            var rotation1 = 70f;
            var rotation2 = 20f;
            ...
            var obj2 = new MoveableInstance { RotationY = rotation2 };
        ...
        public void RotateAsGroup_SetsRotation_AdjustsChildRotations_RotatesChildPositions()
        {
            ...
            var obj3 = new MoveableInstance { RotationY = rotation3, Position = position3 };
